 ...
 * <p>
 * This builder provides a fluent API for creating instances of org.javahelpers.simple.builders.example.JacksonIntegrationDto with
...
@BuilderImplementation(
    forClass = JacksonIntegrationDto.class
)
@JsonPOJOBuilder(
    withPrefix = ""
)
public class JacksonIntegrationDtoBuilder implements IBuilderBase<JacksonIntegrationDto> {
   ...
   */
  public JacksonIntegrationDtoBuilder conditional(BooleanSupplier condition,
      Consumer<JacksonIntegrationDtoBuilder> trueCase,
      Consumer<JacksonIntegrationDtoBuilder> falseCase) {
  ...
  public interface With {
    ...
    default JacksonIntegrationDto with(Consumer<JacksonIntegrationDtoBuilder> b) {
      ...
      try {
        ...
        throw new IllegalArgumentException("The interface 'JacksonIntegrationDtoBuilder.With' should only be implemented by classes, which could be casted to 'JacksonIntegrationDto'", ex);
      }
      b.accept(builder);
