...
class BuilderProcessorTest {
  ...
  void shouldGenerateConsumerMethodsForConstructorFieldsWithCustomTypes() {
    ...
    ProcessorAsserts.assertContaining(
        ...
        "Address consumer = !this.address.isUnset() ? this.address.value() : new Address();",
  ...
  void shouldGenerateConsumerByBuilderForAnnotatedField() {
    ...
    ProcessorAsserts.assertContaining(
        ...
        "helperBuilderConsumer",
        "HelperAnnoBuilder builder = !this.helper.isUnset() ? new HelperAnnoBuilder(this.helper.value()) : new HelperAnnoBuilder();",
  ...
  void shouldGenerateConsumerForCustomTypeWithEmptyConstructor() {
    ...
    ProcessorAsserts.assertContaining(
        generatedCode,
        "HelperPlain consumer = !this.helperPlain.isUnset() ? this.helperPlain.value() : new HelperPlain();",
